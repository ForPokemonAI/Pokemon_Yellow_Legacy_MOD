...
; Rematch
	...
	db $FF, 22, PSYDUCK, 21, GOLDEEN, 23, HORSEA, 24, STARMIE, 0

LtSurgeData:
	db $FF, 29, RAICHU, 0
; Rematch
	db $FF, 64, ELECTRODE, 65, MAGNETON, 64, JOLTEON, 64, PORYGON, 64, ELECTABUZZ, 65, RAICHU, 0
	db $FF, 35, ELECTABUZZ, 40, RAICHU, 0
	db $FF, 43, ELECTABUZZ, 48, RAICHU, 0
	db $FF, 48, MAGNETON, 48, ELECTRODE, 50, ELECTABUZZ, 55, RAICHU, 0
	db $FF, 50, MAGNETON, 50, ELECTRODE, 53, ELECTABUZZ, 58, RAICHU, 0
...
; Rematch
	...
	db $FF, 51, TANGELA, 52, VICTREEBEL, 51, VENUSAUR, 52, EXEGGUTOR, 53, VILEPLUME, 0
...
SabrinaData:
	...
	db $FF, 53, ABRA,  51, HYPNO, 52, MR_MIME, 53, KADABRA,  53, ALAKAZAM, 0
; Rematch
