...
; Characteristics of each move.
	...
	move NIGHT_SHADE,  ATTACK_DOWN_SIDE_EFFECT,        75, GHOST,        100, 15 ; buffed damage to 75 to balance this out. Otherwise it's just too low(like Ninetales' flamethrower is always better than Night shade, attack down is just thematically fine, scary don't perform)
